...
function Footer() {
    return ( 
        <div className='container text-center border-top p-4'>
            <div className='row'>
                <div className='col'>
                    <img src='images/logo.svg' style={{width:"50%"}} alt="Company Logo" />
                    <p className='fs-9 mt-3'>© 2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>
                </div>
                <div className='col'>
                    <p>Company</p>
                    ...
                    <a href='' style={{ textDecoration: "none" }}>Referral</a><br/>
                    <a href='' style={{ textDecoration: "none" }}>Careers</a><br/>
                    <a href='' style={{ textDecoration: "none" }}>Zerodha</a><br/>
                    <a href='' style={{ textDecoration: "none" }}>Open Account</a><br/>
                    <a href='' style={{ textDecoration: "none" }}>Press</a><br/>
                    <a href='' style={{ textDecoration: "none" }}>Zerodha Blog</a><br/>
                </div>
                <div className='col'>
                    <p>Support</p> 
                    ...
                    <a href='' style={{ textDecoration: "none" }}>How to file</a><br/>
                    <a href='' style={{ textDecoration: "none" }}>Status of application</a><br/>
                </div>
                <div className='col'>
                    <p>Account</p>
           ...
           <div className='mt-5 fs-8 small text-muted'> 
