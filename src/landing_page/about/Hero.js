...
function Hero() {
  return (
    <div className="container">
      <div className="row">
        <h1 className="mt-5 mb-5 fs-2 text-center p-5 border-bottom" style={{}}>
          We pioneered the discount broking model in India.
          <br /> Now, we are breaking ground with our technology.
        </h1>
      </div>
      <div className="row p-5  text-muted fs-6" style={{lineHeight:"1.8",fontSize:"1.8em"}}>
        <div className="col-6 p-5">
          <p className="">
            ...
            technology have made us the biggest stock broker in India.</p> Over 1+
