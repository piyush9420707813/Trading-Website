        ...
        <div className='container mt-5'>
            <div className='row'>
                ...
                <div className='col-6 p-5 mt-5'>
                       ...
                       <a href='/'className='mb-5'style={{textDecoration:"none"}}> Varsity <i class="fa fa-long-arrow-right"></i> </a>
                       ...
                       <a href='/'className='mb-3'style={{textDecoration:"none"}}> TradingQ&A  <i class="fa fa-long-arrow-right"></i> </a>
